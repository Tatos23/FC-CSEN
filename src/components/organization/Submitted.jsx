...
const Submitted = () => {
  ...
  return (
    <div>
        ...
        <br />
        <br />
        <button className='bg-cyan-500 rounded-lg px-4 py-2 text-white text-3xl mt-2 mb-4 hover:bg-cyan-700' key={'rep-don'} onClick={() => handleButtonDon('rep-don')}>Donations</button>
    </div>
  )
}
