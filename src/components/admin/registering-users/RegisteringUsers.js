        ...
        <div className='user-submissions'>
            <div className='user-submissions-top-bar'>
                <div className='user-submissions-showing'>
                    <span>Show: </span>
                    <button className={filter === 'All' ? 'user-submissions-selected' : ''} onClick={() => { setFilter('All'); setCurrentPage(1); }}>All</button>
                    <button className={filter === 'Teachers/Doctors' ? 'user-submissions-selected' : ''} onClick={() => { setFilter('Teachers/Doctors'); setCurrentPage(1); }}>Teachers/Doctors</button>
            ...
            <div className='user-submissions-grid'>
                {currentItems.map((user, index) => {
                    if (user.type === 'Donor') {
                        return <UserSubmissionCard key={index} usersData={usersData} setUsersData={setUsersData} user={user} />;
