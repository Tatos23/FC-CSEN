...
return(
    <>
        <div className='background-container'><img src='home.jpg' className='homephoto'></img>
        ...
        <div className='navbar'>
            ...
            <div className='middleside'>
                <button className='middleside-button'style={{ marginRight: '15%' }}>Home</button>   
                <button className='middleside-button'style={{ marginRight: '1%' }}>Donations</button>
                <button className='middleside-button'style={{ marginLeft: '10%' }}>AboutUS</button>
            ...
            <div className='quote'>The best way to find yourself is to lose yourself in the service of others.</div>
